...
const Heading = () => {
  return (
    <div className="p-4 md:p-9 bg-primary flex flex-col md:flex-row gap-4 md:gap-13">
      ...
      <div className="md:flex-[4] flex flex-col gap-4 p-2">
        <div className="flex justify-between items-center w-full">
          ...
          <div className="py-1 px-4 bg-white rounded-[4px]">
            <p className="text-sm md:text-base text-primary">BERITA</p>
          </div>
        </div>
        <div className="flex flex-col gap-3">
          ...
          <p className="text-white font-light text-sm md:text-base">
            ...
            pertamanya untuk POSC meski ia mengalami kelelahan pegal linu,
